...
<div class="container">
  ...
  <main role="main">
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-3">Film Name</h1>
        <p>This is the film description</p>
        <div class="d-flex">
          <p><a class="btn btn-outline-primary btn-lg mr-3" href="#" role="button">Favourite</a></p>
          <p><a class="btn btn-primary btn-lg" href="#" role="button">Donate</a></p>
        </div>
      </div>
    </div>
