        ...
        <div class="col-md-6">
            <div class="card">
                <header class="card-header">
                    <a href="" class="float-right btn btn-transparent text-primary mt-1">Switch to Sign up</a>
                ...
                <div class="border-top card-body text-center">No account? <a href="">Sign Up</a></div>
            </div> <!-- card.// -->
        </div> <!-- col.//-->
